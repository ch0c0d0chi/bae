const qnaList = [
  ...
  {
    q: '(지남력)2. 현재 어떤 계절입니까?봄(3,4,5월)여름(6,7,8월)가을(9,10,11월)겨울(12,1,2월)',
    a: [
      { answer: "text" },    
    ]
  },
  {
    q: '(기억력)3. 오늘 저녁으로 무엇을 먹었습니까?',
    a: [
      { answer: "text"},
    ]
  },
  {
    q: '(기억력)4. 최근 3주동안 여행을 다녀온 적이 있나요?',
    a: [
      { answer: "text" },
    ]
  },
  {
    q: '(기억력)5.단어 3개를 제시하겠습니다. 단어를 암기해주세요.(사과 바나나 포도)',
    a: [
      { answer: "text"},
    ]
  },
